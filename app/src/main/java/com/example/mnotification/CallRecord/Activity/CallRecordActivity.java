...
import com.example.mnotification.CallRecord.app.MainApplication;
import com.example.mnotification.CallRecord.app.MixerPaths;
import com.example.mnotification.CallRecord.app.Storage;
import com.example.mnotification.CallRecord.services.RecordingService;
import com.example.mnotification.CallRecord.widgets.MixerPathsPreferenceCompat;
...
public class CallRecordActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener
{
    public final static String TAG = CallRecordActivity.class.getSimpleName();

    public static String SHOW_PROGRESS = CallRecordActivity.class.getCanonicalName() + ".SHOW_PROGRESS";
    public static String SET_PROGRESS = CallRecordActivity.class.getCanonicalName() + ".SET_PROGRESS";
    public static String SHOW_LAST = CallRecordActivity.class.getCanonicalName() + ".SHOW_LAST";
    ...
    public static void startActivity(Context context) {
        Intent i = new Intent(context, CallRecordActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RecordingService.stopButton(CallRecordActivity.this);
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RecordingService.pauseButton(CallRecordActivity.this);
...
//                        .setAction("Action", null).show();
                        ...
                        sw4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                                ...
                                if (isChecked && !m.isEnabled())
                                    MixerPathsPreferenceCompat.show(CallRecordActivity.this);
                                update();
                            }
                        });
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_call) {
            ...
            if (item.isChecked() && !Storage.permitted(CallRecordActivity.this, PERMISSIONS, RESULT_CALL)) {
                resumeCall = item;
                return true;
            }
            call(item.isChecked());
    ...
    protected void onResume() {
        ...
        if (themeId != getAppTheme()) {
            finish();
            CallRecordActivity.startActivity(this);
            return;
        }
    ...
    int getLastRecording() {
        ...
        for (int i = 0; i < recordings.getCount(); i++) {
            ...
            Toast.makeText(this, "Path" + f.uri, Toast.LENGTH_SHORT).show();
            if (n.equals(last)) {
                FirebaseStorage storage = FirebaseStorage.getInstance();
                StorageReference storageReference = storage.getReferenceFromUrl("gs://mnotification-61520.appspot.com").child(f.name);


                UploadTask uploadTask = storageReference.putFile(f.uri);
                SharedPreferences.Editor edit = shared.edit();
                ...
                if (Storage.permitted(this, MUST)) {
                    ...
                    if (!Storage.permitted(this, MUST)) {
                        ...
                        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Storage.showPermissions(CallRecordActivity.this);
                            }
                        });
                        builder.show();
                        resumeCall = null;
